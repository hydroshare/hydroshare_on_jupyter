...
def get_index_html(dev_mode=False):
    """ Gets the HTML needed to load the web app
        :param dev_mode: if True, uses the bundle in "webapp/build" generated by "yarn build",
         otherwise uses the bundle in "webapp/dist" generated by "yarn deploy"
        :type dev_mode: bool
    """
    global _frontend_url
    global _backend_api_url
...
<html lang="en">
  ...
  <body>
    ...
    <script type="text/javascript" src="{_frontend_url}/assets/bundle-{bundle_suffix}.js">
    </script>
  </body>
</html>
"""
